...
//test
import EventCard from './sh/Inbox2.jsx'
...
function App() {
  ...
  const shouldHideAllNavs = hideAllNavsPaths.some(
    path => location.pathname === path
  )
  const shouldHideEventNav = hideEventNavPaths.some(
    path => location.pathname === path
  )
