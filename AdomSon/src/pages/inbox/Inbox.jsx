...
const Inbox = () => {
  ...
  const handleView = async (eventId) => {
    try {
      const response = await axios.get(`http://localhost:1045/event/get-event/${eventId}`);
            ...
            return (
              <div key={event.eventId} className="event-card1">
                ...
                <div className="event-details1">
                  ...
                  <p>
                    {event.eventInfo?.eventStartDate ? new Date(event.eventInfo.eventStartDate).toLocaleDateString() : 'N/A'} - {' '}
                    {event.eventInfo?.eventEndDate ? new Date(event.eventInfo.eventEndDate).toLocaleDateString() : 'N/A'} | {' '}
                    {event.eventInfo?.eventStartTime || 'N/A'} - {event.eventInfo?.eventEndTime || 'N/A'}
                  </p>
            ...
            <div className="modal-content">
              ...
              <div className="modal-header">
                ...
                <div className="approval-status">
                  <span>HOD Status: <strong>{selectedEvent.hodApprovalStatus || "N/A"}</strong></span>
                  {userType === "CSO" && (
                    <span>CSO Status: <strong>{selectedEvent.csoApprovalStatus || "N/A"}</strong></span>
                  )}
                  {userType === "PRINCIPAL" && (
                    <span>Principal Status: <strong>{selectedEvent.principalApprovalStatus || "N/A"}</strong></span>
                  )}
                </div>
              </div>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.eventOrganizingInstitution || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.eventStartDate ? 
                            new Date(selectedEvent.eventInfo.eventStartDate).toLocaleDateString() : "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.eventEndDate ? 
                            new Date(selectedEvent.eventInfo.eventEndDate).toLocaleDateString() : "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                      ...
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.eventStartTime || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                      ...
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.intendedAudience || "N/A"}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.leadCoOrdinator || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                        <label>Faculty Coordinator:</label>
                        <div className="form-value">
                          {selectedEvent.eventInfo?.facultyCoOrdinator || "N/A"}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      <div className="form-field">
                        <label>Name:</label>
                        <div className="form-value">
                          {selectedEvent.eventInfo?.name_Of_The_Speaker || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                      ...
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.affiliated_Organization || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.estimated_Student_Participation || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                        <label>Estimated Faculty:</label>
                        <div className="form-value">
                          {selectedEvent.eventInfo?.estimated_Faculty_Participation || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                        <label>Total Expected:</label>
                        <div className="form-value">
                          {selectedEvent.eventInfo?.total_Expected_Attendence || "N/A"}
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="form-section">
                    ...
                    <div className="form-grid">
                      <div className="form-field">
                        ...
                        <div className="form-value">
                          {selectedEvent.eventInfo?.guest_Accomodation || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                        <label>Transportation:</label>
                        <div className="form-value">
                          {selectedEvent.eventInfo?.guest_Transportation || "N/A"}
                        </div>
                      </div>
                      <div className="form-field">
                        <label>Food:</label>
